...
// Определяем формат вывода сообщений (по умолчанию)
#define MessFormat   tfm_FULL    
...
class TQueMessage
{
  ...
  bool Send(tStruMessage xMessage, String Type, String Source, int Number, int fmess32); 
  String Receive();
