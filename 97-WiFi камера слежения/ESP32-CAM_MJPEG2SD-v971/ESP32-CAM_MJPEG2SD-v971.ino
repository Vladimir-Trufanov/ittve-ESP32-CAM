/*
* Преобразовать изображения ESP32 CAM в формат JPEG в AVI-файл и сохраните на 
* SD-карте. AVI-файлы, хранящиеся на SD-карте, также можно выбрать и передать в 
* браузер в формате MJPEG.
*
* s60sc 2020 - 2024
*/
