...
// - Установить интервал синхронизации работы SNTP.
//   void sntp_set_sync_interval(uint32_t interval_ms) 
//   Примечание: SNTPv4 RFC 4330 устанавливает минимальный интервал синхронизации в 15 секунд. 
//   Этот интервал синхронизации будет использоваться при следующей попытке обновить время с 
//   помощью SNTP. Чтобы применить новый интервал синхронизации, вызовите функцию sntp_restart(),
//   в противном случае он будет применён после истечения последнего интервала.
//   Параметр interval_ms - интервал синхронизации в миллисекундах. Он не может быть меньше 15 секунд, 
//   иначе будет установлено значение 15 секунд (мах=4294967295=71582788мин=1193046час=49710сут=135лет. 
